    ...
    >
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className=" flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] mt-3 text-white ss:leading-[100px] leading-[72px]">
        ...
        <p className={`${styles.paragraph} max-w-[472px] mt-5`}>
          ...
          incidunt quisquam hic nulla, non omnis sit eius doloribus, fugiat
          atque fuga.
        </p>
      </div>

      <div
        className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative robot-hero`}
      >
        <img
          src={robot}
          alt="robot"
          className="w-[100%] h-[100%] relative z-[5] robot"
        />
        {/* 
